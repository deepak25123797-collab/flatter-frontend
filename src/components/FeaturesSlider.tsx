    ...
    <section className="bg-[#F7F7F5] py-20">
      <div className="container-custom">
        ...
        <div className="mb-10 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-start">
          <div>
            <h2 className="text-4xl md:text-5xl font-semibold tracking-[-0.04em] text-[#0F172A]">
              {t('features.title')}
            </h2>
          </div>
        ...
        <div className="rounded-[32px] bg-[#0F172A] p-8 shadow-[0_24px_70px_rgba(15,23,42,0.18)]">
          <div className="grid gap-6 lg:grid-cols-[auto_1fr] items-center">
            <div className="flex items-center justify-center">
              <button className="inline-flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-transparent text-white transition hover:bg-white/10">
                <FaArrowLeft size={18} />
              </button>
            </div>
