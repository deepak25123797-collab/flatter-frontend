      ...
      <div className="container-custom">
        ...
        <div className="rounded-[40px] bg-[#0F172A] p-8 shadow-[0_30px_80px_rgba(15,23,42,0.16)]">
          <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] items-start">
            ...
            <div className="relative w-full max-w-full rounded-[32px] bg-[#FCFBF8] p-6 sm:p-8 xl:p-10 shadow-[0_25px_70px_rgba(15,23,42,0.08)]">
              <div className="flex min-w-0 flex-wrap items-center justify-between gap-4">
                <div className="flex min-w-0 items-center gap-3 text-xs uppercase tracking-[0.35em] text-[#94A3B8]">
                  <FaSun className="text-[#94A3B8]" />
                  <span>{t('mortgage.monthlyPayment')}</span>
                </div>
                <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full border border-[#0F172A]/20 text-[#0F172A]">
                  <FaArrowUp size={22} />
                </div>
              </div>
              <div className="mt-6">
                <p className="text-[2.6rem] sm:text-[3rem] md:text-[3.75rem] leading-tight font-semibold tracking-[-0.04em] text-[#0F172A]">$17,8120.20</p>
